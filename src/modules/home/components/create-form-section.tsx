...
export default function CreateFormSection() {
  ...
  return (
    <div className="bg-surface-500/60 rounded-xl p-8">
      ...
      <button
        onClick={handleClick}
        className="border-surface-500/80 hover:border-primary-500 active:border-secondary-500 flex aspect-square max-h-52 min-h-48 flex-1 cursor-pointer flex-col overflow-hidden rounded-2xl border transition duration-200 hover:shadow-md active:scale-[0.98] active:shadow-none"
      >
